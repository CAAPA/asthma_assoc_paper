...
site=$1
dataset=$2 #gwas/adpc
pdf_file=../../caapa_imputation_pipeline/data/output/${site}/statistics/${dataset}.pdf
work_file=../../caapa_imputation_pipeline/data/working/${site}/${dataset}_imputation_statistics_text.txt
out_file_1=../../caapa_imputation_pipeline/data/working/${site}/${dataset}_imputation_statistics_1.txt
out_file_2=../../caapa_imputation_pipeline/data/working/${site}/${dataset}_imputation_statistics_2.txt
